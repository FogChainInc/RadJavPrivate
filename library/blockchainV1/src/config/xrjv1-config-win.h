...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "Higher Edge Software, LLC"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Higher Edge Software, LLC"
...
#define PACKAGE_NAME "RadJav Blockchain V1"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "RadJav Blockchain V1 based on Bitcoin Core 0.14.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "radjav-blockchainv1"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://radjav.com/"
