...
#define BOOST_TEST_MODULE XRJV1 Test Suite

#include "test_xrjv1.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_xrjv1_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
