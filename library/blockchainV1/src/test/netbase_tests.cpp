...
{
    BOOST_CHECK(TestSplitHost("www.radjav.com", "www.radjav.com", -1));
    BOOST_CHECK(TestSplitHost("[www.radjav.com]", "www.radjav.com", -1));
    BOOST_CHECK(TestSplitHost("www.radjav.com:80", "www.radjav.com", 80));
    BOOST_CHECK(TestSplitHost("[www.radjav.com]:80", "www.radjav.com", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9890", "127.0.0.1", 9890));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9890", "127.0.0.1", 9890));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9890", "::ffff:127.0.0.1", 9890));
    BOOST_CHECK(TestSplitHost("[::]:9890", "::", 9890));
    BOOST_CHECK(TestSplitHost("::9890", "::9890", -1));
    BOOST_CHECK(TestSplitHost(":9890", "", 9890));
    BOOST_CHECK(TestSplitHost("[]:9890", "", 9890));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9890", "127.0.0.1:9890"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9890", "[::]:9890"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
