...
#ifndef XRJV1_TEST_SCRIPTNUM10_H
#define XRJV1_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from XRJV1 Core 0.10.0, for cross-comparison.
 */
public:
