...
#ifndef XRJV1_QT_XRJV1UNITS_H
#define XRJV1_QT_XRJV1UNITS_H
...
/** XRJV1 unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class XRJV1Units: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit XRJV1Units(QObject *parent);

    /** XRJV1 units.
      @note Source: https://en.xrjv1.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        XRJ,
...
typedef XRJV1Units::Unit XRJV1Unit;

#endif // XRJV1_QT_XRJV1UNITS_H
