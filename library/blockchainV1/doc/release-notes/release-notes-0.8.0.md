XRJV1-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/xrjv1/files/XRJV1/xrjv1-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the XRJV1
...
New/changed settings (command-line or xrjv1.conf file)
--------------------------------------------------------
