XRJV1 Core version 0.10.4 is now available from:

  <https://xrjv1.org/bin/xrjv1-core-0.10.4/>
...
- #6953 `43c2789` Split xrjv1-tx into its own package
- #6953 `dfe0d4d` Include xrjv1-tx binary on Debian/Ubuntu
