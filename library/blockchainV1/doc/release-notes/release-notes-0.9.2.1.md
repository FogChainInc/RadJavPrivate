XRJV1 Core version 0.9.2.1 is now available from:

  https://xrjv1.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 XRJ to 0.01 XRJ
...
- Fix "Start xrjv1 on system login"
