XRJV1 version 0.7.2 is now available from:
  http://sourceforge.net/projects/xrjv1/files/XRJV1/xrjv1-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused XRJV1-Qt to crash on Windows when exiting.
