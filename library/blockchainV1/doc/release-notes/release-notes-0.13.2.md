XRJV1 Core version 0.13.2 is now available from:

  <https://xrjv1.org/bin/xrjv1-core-0.13.2/>
...
- #8908 `4a974b2` Update xrjv1-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow xrjv1-tx to create v2 transactions (XRJdrak)
