XRJV1 Core version 0.9.4 is now available from:

  https://xrjv1.org/bin/0.9.4/
...
this update is incompatible with the XRJV1 system and could lead to consensus
forks.

XRJV1 Core released binaries from https://xrjv1.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~xrjv1/+archive/ubuntu/xrjv1
- A third-party or self-compiled XRJV1 Core

upgrade to XRJV1 Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
