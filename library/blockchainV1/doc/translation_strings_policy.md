...
This document provides guidelines for internationalization of the XRJV1 Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `xrjv1_en.ts` remains unchanged.
