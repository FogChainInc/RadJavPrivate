...
# TestNode: A peer we use to send messages to xrjv1d, and store responses.
...
class CompactBlocksTest(XRJV1TestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes xrjv1d to (reasonably!) disconnect us, so do this last.
    ...
    # Test that xrjv1d requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for xrjv1d to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # xrjv1d will not send blocktxn responses for blocks whose height is
