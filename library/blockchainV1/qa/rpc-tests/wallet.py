...
class WalletTest (XRJV1TestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 XRJ from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 XRJ in block rewards plus fees, but
        ...
        # Send 10 XRJ with subtract fee from amount
        ...
        # Sendmany 10 XRJ with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/xrjv1/xrjv1/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
