...
import RPC call and node 0 sends XRJ to it. Then other nodes import the
...
In the second part of the test, node 0 sends more XRJ to each address, and the
...
class ImportRescanTest(XRJV1TestFramework):
    def __init__(self):
        super().__init__()
