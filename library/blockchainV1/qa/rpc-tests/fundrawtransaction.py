...
class RawTransactionsTest(XRJV1TestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid xrjv1 address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid xrjv1 address" in e.error['message'])
