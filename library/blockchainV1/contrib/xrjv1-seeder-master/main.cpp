...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "xrjv1-seeder\n"
...
static const string mainnet_seeds[] = {
		...
		"xrjv1seed3.radjav.com", 
		"xrjv1seed4.radjav.com", 
		"xrjv1seed5.radjav.com", 
		"xrjv1seed6.radjav.com", 
		""
	};
static const string testnet_seeds[] = {
		"xrjv1-test-seed1.radjav.com", 
		""
	};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9890), true);
  }
  do {
