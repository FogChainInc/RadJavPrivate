...
unlocked to sign the XRJV1-Qt.app bundle.
...
allowing somebody to distribute a XRJV1-Qt.app or xrjv1-qt-setup.exe with a valid
...
that the xrjv1-qt.exe file inside the installer had not been tampered with.
