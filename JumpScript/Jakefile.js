...
var compilerSources = filesFromConfig("./src/compiler/jmpconfig.json");
var servicesSources = filesFromConfig("./src/services/jmpconfig.json");
var cancellationTokenSources = filesFromConfig(path.join(serverDirectory, "cancellationToken/jmpconfig.json"));
var typingsInstallerSources = filesFromConfig(path.join(serverDirectory, "typingsInstaller/jmpconfig.json"));
var watchGuardSources = filesFromConfig(path.join(serverDirectory, "watchGuard/jmpconfig.json"));
var serverSources = filesFromConfig(path.join(serverDirectory, "jmpconfig.json"))
var languageServiceLibrarySources = filesFromConfig(path.join(serverDirectory, "jmpconfig.library.json"));

var typesMapOutputPath = path.join(builtLocalDirectory, 'typesMap.json');

var harnessCoreSources = [
    "harness.jump",
    "virtualFileSystem.jump",
    "virtualFileSystemWithWatch.jump",
    "sourceMapRecorder.jump",
    "harnessLanguageService.jump",
    "fourslash.jump",
    "runnerbase.jump",
    "compilerRunner.jump",
    "typeWriter.jump",
    "fourslashRunner.jump",
    "projectsRunner.jump",
    "loggedIO.jump",
    "rwcRunner.jump",
    "externalCompileRunner.jump",
    "test262Runner.jump",
    "./parallel/shared.jump",
    "./parallel/host.jump",
    "./parallel/worker.jump",
    "runner.jump"
].map(function (f) {
...
var harnessSources = harnessCoreSources.concat([
    "incrementalParser.jump",
    "jsDocParsing.jump",
    "services/colorization.jump",
    "services/documentRegistry.jump",
    "services/preProcessFile.jump",
    "services/patternMatcher.jump",
    "session.jump",
    "versionCache.jump",
    "convertToBase64.jump",
    "transpile.jump",
    "reuseProgramStructure.jump",
    "textStorage.jump",
    "moduleResolution.jump",
    "jmpconfigParsing.jump",
    "asserts.jump",
    "builder.jump",
    "commandLineParsing.jump",
    "configurationExtension.jump",
    "convertCompilerOptionsFromJson.jump",
    "convertTypeAcquisitionFromJson.jump",
    "jmpserverProjectSystem.jump",
    "jmpcWatchMode.jump",
    "compileOnSave.jump",
    "typingsInstaller.jump",
    "projectErrors.jump",
    "matchFiles.jump",
    "initializeTSConfig.jump",
    "extractConstants.jump",
    "extractFunctions.jump",
    "extractRanges.jump",
    "extractTestHelpers.jump",
    "printer.jump",
    "textChanges.jump",
    "telemetry.jump",
    "transform.jump",
    "customTransforms.jump",
    "programMissingFiles.jump",
    "symbolWalker.jump",
    "languageService.jump",
    "publicApi.jump",
    "hostNewLineSupport.jump",
].map(function (f) {
    return path.join(unittestsDirectory, f);
})).concat([
    "protocol.jump",
    "utilities.jump",
    "scriptVersionCache.jump",
    "scriptInfo.jump",
    "project.jump",
    "typingsCache.jump",
    "editorServices.jump",
...
var es2015LibrarySources = [
    "es2015.core.d.jump",
    "es2015.collection.d.jump",
    "es2015.generator.d.jump",
    "es2015.iterable.d.jump",
    "es2015.promise.d.jump",
    "es2015.proxy.d.jump",
    "es2015.reflect.d.jump",
    "es2015.symbol.d.jump",
    "es2015.symbol.wellknown.d.jump"
];

var es2015LibrarySourceMap = es2015LibrarySources.map(function (source) {
    return { target: "lib." + source, sources: ["header.d.jump", source] };
});

var es2016LibrarySource = ["es2016.array.include.d.jump"];
...
var es2017LibrarySource = [
    "es2017.object.d.jump",
    "es2017.sharedmemory.d.jump",
    "es2017.string.d.jump",
    "es2017.intl.d.jump",
    "es2017.typedarrays.d.jump",
];
...
var esnextLibrarySource = [
    "esnext.asynciterable.d.jump",
    "esnext.array.d.jump",
    "esnext.promise.d.jump"
];
...
var hostsLibrarySources = ["dom.generated.d.jump", "webworker.imporjmpcripts.d.jump", "scripthost.d.jump"];

var librarySourceMap = [
    // Host library
    { target: "lib.dom.d.jump", sources: ["header.d.jump", "dom.generated.d.jump"] },
    { target: "lib.dom.iterable.d.jump", sources: ["header.d.jump", "dom.iterable.d.jump"] },
    { target: "lib.webworker.d.jump", sources: ["header.d.jump", "webworker.generated.d.jump"] },
    { target: "lib.scripthost.d.jump", sources: ["header.d.jump", "scripthost.d.jump"] },

    // JavaScript library
    { target: "lib.es5.d.jump", sources: ["header.d.jump", "es5.d.jump"] },
    { target: "lib.es2015.d.jump", sources: ["header.d.jump", "es2015.d.jump"] },
    { target: "lib.es2016.d.jump", sources: ["header.d.jump", "es2016.d.jump"] },
    { target: "lib.es2017.d.jump", sources: ["header.d.jump", "es2017.d.jump"] },
    { target: "lib.es2018.d.jump", sources: ["header.d.jump", "es2018.d.jump"] },
    { target: "lib.esnext.d.jump", sources: ["header.d.jump", "esnext.d.jump"] },

    // JavaScript + all host library
    { target: "lib.d.jump", sources: ["header.d.jump", "es5.d.jump"].concat(hostsLibrarySources) },
    { target: "lib.es6.d.jump", sources: ["header.d.jump", "es5.d.jump"].concat(es2015LibrarySources, hostsLibrarySources, "dom.iterable.d.jump") },
    { target: "lib.es2016.full.d.jump", sources: ["header.d.jump", "es2016.d.jump"].concat(hostsLibrarySources, "dom.iterable.d.jump") },
    { target: "lib.es2017.full.d.jump", sources: ["header.d.jump", "es2017.d.jump"].concat(hostsLibrarySources, "dom.iterable.d.jump") },
    { target: "lib.es2018.full.d.jump", sources: ["header.d.jump", "es2018.d.jump"].concat(hostsLibrarySources, "dom.iterable.d.jump") },
    { target: "lib.esnext.full.d.jump", sources: ["header.d.jump", "esnext.d.jump"].concat(hostsLibrarySources, "dom.iterable.d.jump") },
...
var processDiagnosticMessagesTs = path.join(scriptsDirectory, "processDiagnosticMessages.jump");
var diagnosticMessagesJson = path.join(compilerDirectory, "diagnosticMessages.json");
var diagnosticInfoMapTs = path.join(compilerDirectory, "diagnosticInformationMap.generated.jump");
...
var generateLocalizedDiagnosticMessagesTs = path.join(scriptsDirectory, "generateLocalizedDiagnosticMessages.jump");
...
var buildProtocolTs = path.join(scriptsDirectory, "buildProtocol.jump");
var buildProtocolJs = path.join(scriptsDirectory, "buildProtocol.js");
var buildProtocolDts = path.join(builtLocalDirectory, "protocol.d.jump");
var jumpscriptServicesDts = path.join(builtLocalDirectory, "jumpscriptServices.d.jump");
...
file(buildProtocolDts, [buildProtocolTs, buildProtocolJs, jumpscriptServicesDts], function() {

    var protocolTs = path.join(serverDirectory, "protocol.jump");

    var cmd = host + " " + buildProtocolJs + " "+ protocolTs + " " + jumpscriptServicesDts + " " + buildProtocolDts;
    console.log(cmd);
    var ex = jake.createExec([cmd]);
    // Add listeners for output and error
    ex.addListener("stdout", function (output) {
...
desc("Generates a diagnostic file in JumpScript based on an input JSON file");
task("generate-diagnostics", [diagnosticInfoMapTs]);

// Publish nightly
var configurePrereleaseJs = path.join(scriptsDirectory, "configurePrerelease.js");
var configurePrereleaseTs = path.join(scriptsDirectory, "configurePrerelease.jump");
var packageJson = "package.json";
var versionFile = path.join(compilerDirectory, "core.jump");
...
var importDefinitelyTypedTestsTs = path.join(importDefinitelyTypedTestsDirectory, "importDefinitelyTypedTests.jump");
...
var jmpcFile = path.join(builtLocalDirectory, compilerFilename);
compileFile(jmpcFile, compilerSources, [builtLocalDirectory, copyright].concat(compilerSources), [copyright], /*useBuiltCompiler:*/ false);

var servicesFile = path.join(builtLocalDirectory, "jumpscriptServices.js");
var standaloneDefinitionsFile = path.join(builtLocalDirectory, "jumpscriptServices.d.jump");
var nodePackageFile = path.join(builtLocalDirectory, "jumpscript.js");
var nodeDefinitionsFile = path.join(builtLocalDirectory, "jumpscript.d.jump");
var nodeStandaloneDefinitionsFile = path.join(builtLocalDirectory, "jumpscript_standalone.d.jump");
...
compileFile(servicesFile, servicesSources, [builtLocalDirectory, copyright].concat(servicesSources),
        ...
        // 'ts' namespace with '"jumpscript"' as a module.
        var nodeStandaloneDefinitionsFileContents = definitionFileContents.replace(/declare (namespace|module) ts/g, 'declare module "jumpscript"');
        fs.writeFileSync(nodeStandaloneDefinitionsFile, nodeStandaloneDefinitionsFileContents);
    });

file(jumpscriptServicesDts, [servicesFile]);
...
var serverFile = path.join(builtLocalDirectory, "jmpserver.js");
compileFile(serverFile, serverSources, [builtLocalDirectory, copyright, cancellationTokenFile, typingsInstallerFile, watchGuardFile].concat(serverSources).concat(servicesSources), /*prefixes*/ [copyright], /*useBuiltCompiler*/ true, { types: ["node"], preserveConstEnums: true, lib: "es6" });
var jmpserverLibraryFile = path.join(builtLocalDirectory, "jmpserverlibrary.js");
var jmpserverLibraryDefinitionFile = path.join(builtLocalDirectory, "jmpserverlibrary.d.jump");
...
compileFile(
    ...
    /*callback*/ function () {
        prependFile(copyright, jmpserverLibraryDefinitionFile);

        // Appending exports at the end of the server library
        var jmpserverLibraryDefinitionFileContents =
            fs.readFileSync(jmpserverLibraryDefinitionFile).toString() +
            "\nexport = ts;" +
            "\nexport as namespace ts;";
        jmpserverLibraryDefinitionFileContents = removeConstModifierFromEnumDeclarations(jmpserverLibraryDefinitionFileContents);

        fs.writeFileSync(jmpserverLibraryDefinitionFile, jmpserverLibraryDefinitionFileContents);
    });

// Local target to build the language service server library
desc("Builds language service server library");
task("lssl", [jmpserverLibraryFile, jmpserverLibraryDefinitionFile, typesMapOutputPath]);
...
task("local", ["build-fold-start", "generate-diagnostics", "lib", jmpcFile, servicesFile, nodeDefinitionsFile, serverFile, buildProtocolDts, builtGeneratedDiagnosticMessagesJSON, "lssl", "localize", "build-fold-end"]);

// Local target to build only jmpc.js
desc("Builds only the compiler");
task("jmpc", ["generate-diagnostics", "lib", jmpcFile]);
...
var word2mdTs = path.join(scriptsDirectory, "word2md.jump");
var specWord = path.join(docDirectory, "JumpScript Language Specification.docx");
...
task("LKG", ["clean", "release", "local"].concat(libraryTargets), function () {
    var expectedFiles = [jmpcFile, servicesFile, serverFile, nodePackageFile, nodeDefinitionsFile, standaloneDefinitionsFile, jmpserverLibraryFile, jmpserverLibraryDefinitionFile, cancellationTokenFile, typingsInstallerFile, buildProtocolDts, watchGuardFile].
...
compileFile(
    ...
    /*prereqs*/[builtLocalDirectory, jmpcFile, jmpserverLibraryFile].concat(libraryTargets).concat(servicesSources).concat(harnessSources),
    /*prefixes*/[],
    /*useBuiltCompiler:*/ true,
...
var nodeServerInFile = "tests/webTestServer.jump";
compileFile(nodeServerOutFile, [nodeServerInFile], [builtLocalDirectory, jmpcFile], [], /*useBuiltCompiler:*/ true, { noOutFile: true, lib: "es6" });
...
// Webhost
var webhostPath = "tests/webhost/webjmpc.jump";
var webhostJsPath = "tests/webhost/webjmpc.js";
compileFile(webhostJsPath, [webhostPath], [jmpcFile, webhostPath].concat(libraryTargets), [], /*useBuiltCompiler*/true);

desc("Builds the jmpc web host");
task("webhost", [webhostJsPath], function () {
    jake.cpR(path.join(builtLocalDirectory, "lib.d.jump"), "tests/webhost/", { silent: true });
});

// Perf compiler
var perfjmpcPath = "tests/perfjmpc.jump";
var perfjmpcJsPath = "built/local/perfjmpc.js";
compileFile(perfjmpcJsPath, [perfjmpcPath], [jmpcFile, perfjmpcPath, "tests/perfsys.jump"].concat(libraryTargets), [], /*useBuiltCompiler*/ true);
desc("Builds augmented version of the compiler for perf tests");
task("perfjmpc", [perfjmpcJsPath]);

// Instrumented compiler
var loggedIOpath = harnessDirectory + 'loggedIO.jump';
...
var instrumenterPath = harnessDirectory + 'instrumenter.jump';
var instrumenterJsPath = builtLocalDirectory + 'instrumenter.js';
compileFile(instrumenterJsPath, [instrumenterPath], [jmpcFile, instrumenterPath].concat(libraryTargets), [], /*useBuiltCompiler*/ true, { lib: "es6", types: ["node"], noOutFile: true, outDir: builtLocalDirectory });

desc("Builds an instrumented jmpc.js - run with test=[testname]");
task('jmpc-instrumented', [loggedIOJsPath, instrumenterJsPath, jmpcFile], function () {
...
desc("Updates the sublime plugin's jmpserver");
task("update-sublime", ["local", serverFile], function () {
    jake.cpR(serverFile, "../JumpScript-Sublime-Plugin/jmpserver/");
    jake.cpR(serverFile + ".map", "../JumpScript-Sublime-Plugin/jmpserver/");
});
...
var tslintRulesOutFiles = tslintRules.map(function (p) {
    return path.join(builtLocalDirectory, "tslint/rules", p.replace(".jump", ".js"));
});
...
var tslintFormatterFiles = tslintFormatters.map(function (p) {
    return path.join(tslintFormattersDir, p + ".jump");
});
...
var lintTargets = compilerSources
    ...
    .concat(["instrumenter.jump"].map(function (f) { return path.join(harnessDirectory, f) }))
    .concat(serverSources)
    .concat(tslintRulesFiles)
    .concat(servicesSources)
    .concat(typingsInstallerSources)
    .concat(cancellationTokenSources)
    .concat(["Gulpfile.jump"])
    .concat([nodeServerInFile, perfjmpcPath, "tests/perfsys.jump", webhostPath])
...
task("lint", ["build-rules"], () => {
    ...
    const files = fileMatcher
        ? `src/**/${fileMatcher}`
        : "Gulpfile.jump 'scripts/generateLocalizedDiagnosticMessages.jump' 'scripts/tslint/**/*.jump' 'src/**/*.jump' --exclude 'src/lib/*.d.jump'";
