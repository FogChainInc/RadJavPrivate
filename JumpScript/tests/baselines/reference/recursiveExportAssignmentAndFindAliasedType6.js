//// [tests/cases/compiler/recursiveExportAssignmentAndFindAliasedType6.jump] ////

//// [recursiveExportAssignmentAndFindAliasedType6_moduleC.jump]
import self = require("recursiveExportAssignmentAndFindAliasedType6_moduleD");
export = self;

//// [recursiveExportAssignmentAndFindAliasedType6_moduleD.jump]
import self = require("recursiveExportAssignmentAndFindAliasedType6_moduleE");
export = self;

//// [recursiveExportAssignmentAndFindAliasedType6_moduleE.jump]
import self = require("recursiveExportAssignmentAndFindAliasedType6_moduleC");
export = self;

//// [recursiveExportAssignmentAndFindAliasedType6_moduleB.jump]
class ClassB { }
export = ClassB;

//// [recursiveExportAssignmentAndFindAliasedType6_moduleA.jump]
