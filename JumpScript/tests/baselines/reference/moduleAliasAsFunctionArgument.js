//// [tests/cases/compiler/moduleAliasAsFunctionArgument.jump] ////

//// [moduleAliasAsFunctionArgument_0.jump]
export var x: number;

//// [moduleAliasAsFunctionArgument_1.jump]
///<reference path='moduleAliasAsFunctionArgument_0.jump'/>
