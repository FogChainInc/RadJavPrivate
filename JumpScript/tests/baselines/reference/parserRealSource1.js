...
(function (JumpScript) {
    ...
    JumpScript.NullLogger = NullLogger;
    ...
    JumpScript.LoggerAdapter = LoggerAdapter;
    ...
    JumpScript.BufferedLogger = BufferedLogger;
    ...
    JumpScript.timeFunction = timeFunction;
    ...
    JumpScript.stringToLiteral = stringToLiteral;
