...
module JumpScript {
    ...
    export class EnclosingScopeContext {
        ...
        public getScriptFragment(): Script {
            if (this.scriptFragment == null) {
                ...
                this.scriptFragment = JumpScript.quickParse(this.logger, ast, this.text, minChar, limChar, null/*errorCapture*/).Script;
            }
    ...
    export function findEnclosingScopeAt(logger: ILogger, script: Script, text: ISourceText, pos: number, isMemberCompletion: boolean): EnclosingScopeContext {
        ...
        JumpScript.getAstWalkerFactory().walk(script, preFindEnclosingScope, null, null, context);
...
(function (JumpScript) {
    ...
    JumpScript.TypeCollectionContext = TypeCollectionContext;
    ...
    JumpScript.MemberScopeContext = MemberScopeContext;
    ...
    JumpScript.EnclosingScopeContext = EnclosingScopeContext;
    ...
    JumpScript.preFindMemberScope = preFindMemberScope;
    ...
    JumpScript.pushTypeCollectionScope = pushTypeCollectionScope;
    function popTypeCollectionScope(context) {
        context.scopeChain = context.scopeChain.previous;
    }
    JumpScript.popTypeCollectionScope = popTypeCollectionScope;
    ...
    JumpScript.preFindEnclosingScope = preFindEnclosingScope;
    //
    // Find the enclosing scope context from a position inside a script AST.
    // The "scopeStartAST" of the returned scope is always valid.
    // Return "null" if the enclosing scope can't be found.
    ...
    JumpScript.findEnclosingScopeAt = findEnclosingScopeAt;
