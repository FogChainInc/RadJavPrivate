//// [parserRealSource13.jump]
// Copyright (c) Microsoft. All rights reserved. Licensed under the Apache License, Version 2.0. 
// See LICENSE.txt in the project root for complete license information.

///<reference path='jumpscript.jump' />

module JumpScript.AstWalkerWithDetailCallback {
    ...
    export function walk(script: Script, callback: AstWalkerDetailCallback): void {
        ...
        var walker = JumpScript.getAstWalkerFactory().getWalker(pre, post);
...
(function (JumpScript) {
    ...
    })(AstWalkerWithDetailCallback = JumpScript.AstWalkerWithDetailCallback || (JumpScript.AstWalkerWithDetailCallback = {}));
