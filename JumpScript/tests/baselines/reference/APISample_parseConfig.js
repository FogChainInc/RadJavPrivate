//// [APISample_parseConfig.jump]
/*
 * Note: This test is a public API sample. The sample sources can be found 
         at: https://github.com/Microsoft/JumpScript/wiki/Using-the-Compiler-API#a-minimal-compiler
...
export function createProgram(rootFiles: string[], compilerOptionsJson: string): ts.Program | undefined {
    const { config, error } = ts.parseConfigFileTextToJson("jmpconfig.json", compilerOptionsJson)
    if (error) {
        printError(error);
        return undefined;
    }
...
function createProgram(rootFiles, compilerOptionsJson) {
    var _a = ts.parseConfigFileTextToJson("jmpconfig.json", compilerOptionsJson), config = _a.config, error = _a.error;
    if (error) {
        printError(error);
        return undefined;
    }
