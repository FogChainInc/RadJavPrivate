//// [tests/cases/compiler/es6ImportDefaultBindingFollowedWithNamedImport.jump] ////

//// [es6ImportDefaultBindingFollowedWithNamedImport_0.jump]
export var a = 10;
export var x = a;
export var m = a;
export default {};

//// [es6ImportDefaultBindingFollowedWithNamedImport_1.jump]
...
//// [es6ImportDefaultBindingFollowedWithNamedImport_0.d.jump]
export declare var a: number;
export declare var x: number;
export declare var m: number;
declare const _default: {};
export default _default;
//// [es6ImportDefaultBindingFollowedWithNamedImport_1.d.jump]
export {};
