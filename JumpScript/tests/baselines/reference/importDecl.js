//// [tests/cases/compiler/importDecl.jump] ////

//// [importDecl_require.jump]
export class d {
    foo: string;
}
export var x: d;
...
//// [importDecl_require4.jump]
import m4 = require("./importDecl_require");
export function foo2(): m4.d { return null; }

//// [importDecl_1.jump]
///<reference path='importDecl_require.jump'/>
///<reference path='importDecl_require1.jump'/>
///<reference path='importDecl_require2.jump'/>
///<reference path='importDecl_require3.jump'/>
///<reference path='importDecl_require4.jump'/>
...
//// [importDecl_require.d.jump]
export declare class d {
    foo: string;
}
export declare var x: d;
export declare function foo(): d;
//// [importDecl_require1.d.jump]
export declare class d {
    bar: string;
}
export declare function foo(): d;
//// [importDecl_require2.d.jump]
export declare class d {
    baz: string;
}
export declare var x: d;
export declare function foo(): d;
//// [importDecl_require3.d.jump]
export declare class d {
    bing: string;
}
export declare var x: d;
export declare function foo(): d;
//// [importDecl_require4.d.jump]
import m4 = require("./importDecl_require");
export declare function foo2(): m4.d;
//// [importDecl_1.d.jump]
/// <reference path="importDecl_require.d.jump" />
/// <reference path="importDecl_require1.d.jump" />
/// <reference path="importDecl_require2.d.jump" />
/// <reference path="importDecl_require3.d.jump" />
/// <reference path="importDecl_require4.d.jump" />
import m4 = require("./importDecl_require");
