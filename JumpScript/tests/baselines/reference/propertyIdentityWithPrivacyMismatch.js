//// [tests/cases/compiler/propertyIdentityWithPrivacyMismatch.jump] ////

//// [propertyIdentityWithPrivacyMismatch_0.jump]
declare module 'mod1' {
    class Foo {
        private n;
    }
...
//// [propertyIdentityWithPrivacyMismatch_1.jump]
///<reference path='propertyIdentityWithPrivacyMismatch_0.jump'/>
