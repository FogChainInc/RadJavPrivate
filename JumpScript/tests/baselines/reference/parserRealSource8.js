...
module JumpScript {
    ...
    export function preAssignWithScopes(ast: AST, context: AssignScopeContext) {
        ...
        var withScope = new JumpScript.SymbolScopeBuilder(withType.members, withType.ambientMembers, null, null, context.scopeChain.scope, withType.symbol);
...
(function (JumpScript) {
    ...
    JumpScript.AssignScopeContext = AssignScopeContext;
    ...
    JumpScript.pushAssignScope = pushAssignScope;
    function popAssignScope(context) {
        context.scopeChain = context.scopeChain.previous;
    }
    JumpScript.popAssignScope = popAssignScope;
    ...
    JumpScript.instanceCompare = instanceCompare;
    function instanceFilterStop(s) {
        return s.isInstanceProperty();
    }
    JumpScript.instanceFilterStop = instanceFilterStop;
    ...
    JumpScript.ScopeSearchFilter = ScopeSearchFilter;
    JumpScript.instanceFilter = new ScopeSearchFilter(instanceCompare, instanceFilterStop);
    ...
    JumpScript.preAssignModuleScopes = preAssignModuleScopes;
    ...
    JumpScript.preAssignClassScopes = preAssignClassScopes;
    ...
    JumpScript.preAssignInterfaceScopes = preAssignInterfaceScopes;
    ...
    JumpScript.preAssignWithScopes = preAssignWithScopes;
    ...
    JumpScript.preAssignFuncDeclScopes = preAssignFuncDeclScopes;
    ...
    JumpScript.preAssignCatchScopes = preAssignCatchScopes;
    ...
    JumpScript.preAssignScopes = preAssignScopes;
    ...
    JumpScript.postAssignScopes = postAssignScopes;
