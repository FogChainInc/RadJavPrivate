...
module JumpScript {
    ...
    export enum ErrorRecoverySet {
        ...
        JumpScriptS = 1 << 30, // PROPERTY, PRIVATE, STATIC, INTERFACE, CLASS, MODULE, EXPORT, IMPORT
        ExprStart = SColon | AddOp | LCurly | PreOp | RegExp | LParen | LBrack | ID | Prefix | RLit | Func | Literal,
        StmtStart = ExprStart | SColon | Var | Stmt | While | JumpScriptS,
...
(function (JumpScript) {
    ...
    (function (ErrorRecoverySet) {
        ...
        // REVIEW: Name this something clearer.
        ErrorRecoverySet[ErrorRecoverySet["JumpScriptS"] = 1073741824] = "JumpScriptS";
    ...
    })(ErrorRecoverySet = JumpScript.ErrorRecoverySet || (JumpScript.ErrorRecoverySet = {}));
    var AllowedElements;
    ...
    })(AllowedElements = JumpScript.AllowedElements || (JumpScript.AllowedElements = {}));
    var Modifiers;
    (function (Modifiers) {
    ...
    })(Modifiers = JumpScript.Modifiers || (JumpScript.Modifiers = {}));
    var ASTFlags;
    (function (ASTFlags) {
    ...
    })(ASTFlags = JumpScript.ASTFlags || (JumpScript.ASTFlags = {}));
    var DeclFlags;
    (function (DeclFlags) {
    ...
    })(DeclFlags = JumpScript.DeclFlags || (JumpScript.DeclFlags = {}));
    var ModuleFlags;
    ...
    })(ModuleFlags = JumpScript.ModuleFlags || (JumpScript.ModuleFlags = {}));
    var SymbolFlags;
    ...
    })(SymbolFlags = JumpScript.SymbolFlags || (JumpScript.SymbolFlags = {}));
    var VarFlags;
    (function (VarFlags) {
    ...
    })(VarFlags = JumpScript.VarFlags || (JumpScript.VarFlags = {}));
    var FncFlags;
    (function (FncFlags) {
    ...
    })(FncFlags = JumpScript.FncFlags || (JumpScript.FncFlags = {}));
    var SignatureFlags;
    ...
    })(SignatureFlags = JumpScript.SignatureFlags || (JumpScript.SignatureFlags = {}));
    function ToDeclFlags(fncOrVarOrSymbolOrModuleFlags) {
        return fncOrVarOrSymbolOrModuleFlags;
    }
    JumpScript.ToDeclFlags = ToDeclFlags;
    var TypeFlags;
    (function (TypeFlags) {
    ...
    })(TypeFlags = JumpScript.TypeFlags || (JumpScript.TypeFlags = {}));
    ...
    })(TypeRelationshipFlags = JumpScript.TypeRelationshipFlags || (JumpScript.TypeRelationshipFlags = {}));
    var CodeGenTarget;
    (function (CodeGenTarget) {
        CodeGenTarget[CodeGenTarget["ES3"] = 0] = "ES3";
        CodeGenTarget[CodeGenTarget["ES5"] = 1] = "ES5";
    })(CodeGenTarget = JumpScript.CodeGenTarget || (JumpScript.CodeGenTarget = {}));
    var ModuleGenTarget;
    ...
    })(ModuleGenTarget = JumpScript.ModuleGenTarget || (JumpScript.ModuleGenTarget = {}));
    // Compiler defaults to generating ES5-compliant code for
    //  - getters and setters
    JumpScript.codeGenTarget = CodeGenTarget.ES3;
    JumpScript.moduleGenTarget = ModuleGenTarget.Synchronous;
    JumpScript.optimizeModuleCodeGen = true;
    ...
    JumpScript.flagsToString = flagsToString;
