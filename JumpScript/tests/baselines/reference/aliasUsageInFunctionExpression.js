//// [tests/cases/compiler/aliasUsageInFunctionExpression.jump] ////

//// [aliasUsageInFunctionExpression_backbone.jump]
export class Model {
    public someData: string;
}

//// [aliasUsageInFunctionExpression_moduleA.jump]
import Backbone = require("./aliasUsageInFunctionExpression_backbone");
export class VisualizationModel extends Backbone.Model {
    // interesting stuff here
}

//// [aliasUsageInFunctionExpression_main.jump]
import Backbone = require("./aliasUsageInFunctionExpression_backbone");
