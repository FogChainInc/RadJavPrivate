//// [tests/cases/compiler/aliasOnMergedModuleInterface.jump] ////

//// [aliasOnMergedModuleInterface_0.jump]
declare module "foo"
{
    module B {
        export interface A {
...
//// [aliasOnMergedModuleInterface_1.jump]
///<reference path='aliasOnMergedModuleInterface_0.jump' />
