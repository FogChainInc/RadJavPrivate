...
(function (JumpScript) {
    ...
    var AstPath = /** @class */ (function () {
        ...
        AstPath.prototype.isTopLevelImplicitModule = function () {
            return this.count() >= 1 &&
                this.asts[this.top].nodeType === JumpScript.NodeType.ModuleDeclaration &&
                JumpScript.hasFlag(this.asts[this.top].modFlags, JumpScript.ModuleFlags.IsWholeFile);
        };
        AstPath.prototype.isBodyOfTopLevelImplicitModule = function () {
            return this.count() >= 2 &&
                ...
                JumpScript.hasFlag(this.asts[this.top - 1].modFlags, JumpScript.ModuleFlags.IsWholeFile);
        };
    ...
    JumpScript.isValidAstNode = isValidAstNode;
    var AstPathContext = /** @class */ (function () {
        function AstPathContext() {
            this.path = new JumpScript.AstPath();
        }
        return AstPathContext;
    }());
    JumpScript.AstPathContext = AstPathContext;
    ...
    })(GetAstPathOptions = JumpScript.GetAstPathOptions || (JumpScript.GetAstPathOptions = {}));
    ///
    /// Return the stack of AST nodes containing "position"
    ///
    ...
    JumpScript.getAstPathToPosition = getAstPathToPosition;
    //
    // Find a source text offset that is safe for lexing tokens at the given position.
    // This is used when "position" might be inside a comment or string, etc.
    //
    ...
    JumpScript.getTokenizationOffset = getTokenizationOffset;
    ///
    /// Simple function to Walk an AST using a simple callback function.
    ///
