//// [tests/cases/compiler/aliasUsageInOrExpression.jump] ////

//// [aliasUsageInOrExpression_backbone.jump]
export class Model {
    public someData: string;
}

//// [aliasUsageInOrExpression_moduleA.jump]
import Backbone = require("./aliasUsageInOrExpression_backbone");
export class VisualizationModel extends Backbone.Model {
    // interesting stuff here
}

//// [aliasUsageInOrExpression_main.jump]
import Backbone = require("./aliasUsageInOrExpression_backbone");
