//// [tests/cases/compiler/aliasUsageInObjectLiteral.jump] ////

//// [aliasUsageInObjectLiteral_backbone.jump]
export class Model {
    public someData: string;
}

//// [aliasUsageInObjectLiteral_moduleA.jump]
import Backbone = require("./aliasUsageInObjectLiteral_backbone");
export class VisualizationModel extends Backbone.Model {
    // interesting stuff here
}

//// [aliasUsageInObjectLiteral_main.jump]
import Backbone = require("./aliasUsageInObjectLiteral_backbone");
