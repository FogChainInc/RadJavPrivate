//// [tests/cases/compiler/privacyTopLevelAmbientExternalModuleImportWithoutExport.jump] ////

//// [privacyTopLevelAmbientExternalModuleImportWithoutExport_require.jump]
// Public elements
export class c_public {
    foo: string;
}

//// [privacyTopLevelAmbientExternalModuleImportWithoutExport_require1.jump]
export class c_public {
    bar: string;
}

//// [privacyTopLevelAmbientExternalModuleImportWithoutExport_require2.jump]
// private elements
...
//// [privacyTopLevelAmbientExternalModuleImportWithoutExport_require3.jump]
declare module 'm2' {
    export class c_private {
        bing: string;
    }
...
//// [privacyTopLevelAmbientExternalModuleImportWithoutExport_core.jump]
///<reference path='privacyTopLevelAmbientExternalModuleImportWithoutExport_require2.jump'/>
///<reference path='privacyTopLevelAmbientExternalModuleImportWithoutExport_require3.jump'/>
...
//// [privacyTopLevelAmbientExternalModuleImportWithoutExport_require2.d.jump]
declare module 'm' {
    class c_private {
        baz: string;
    }
}
//// [privacyTopLevelAmbientExternalModuleImportWithoutExport_require3.d.jump]
declare module 'm2' {
    class c_private {
        bing: string;
    }
}
//// [privacyTopLevelAmbientExternalModuleImportWithoutExport_require.d.jump]
export declare class c_public {
    foo: string;
}
//// [privacyTopLevelAmbientExternalModuleImportWithoutExport_require1.d.jump]
export declare class c_public {
    bar: string;
}
//// [privacyTopLevelAmbientExternalModuleImportWithoutExport_core.d.jump]
/// <reference path="privacyTopLevelAmbientExternalModuleImportWithoutExport_require2.d.jump" />
/// <reference path="privacyTopLevelAmbientExternalModuleImportWithoutExport_require3.d.jump" />
import im_private_mi_private = require("m");
import im_private_mu_private = require("m2");
import im_private_mi_public = require("privacyTopLevelAmbientExternalModuleImportWithoutExport_require");
