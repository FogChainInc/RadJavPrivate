//// [tests/cases/compiler/aliasUsageInIndexerOfClass.jump] ////

//// [aliasUsageInIndexerOfClass_backbone.jump]
export class Model {
    public someData: string;
}

//// [aliasUsageInIndexerOfClass_moduleA.jump]
import Backbone = require("./aliasUsageInIndexerOfClass_backbone");
export class VisualizationModel extends Backbone.Model {
    // interesting stuff here
}

//// [aliasUsageInIndexerOfClass_main.jump]
import Backbone = require("./aliasUsageInIndexerOfClass_backbone");
