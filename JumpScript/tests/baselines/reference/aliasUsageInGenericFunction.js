//// [tests/cases/compiler/aliasUsageInGenericFunction.jump] ////

//// [aliasUsageInGenericFunction_backbone.jump]
export class Model {
    public someData: string;
}

//// [aliasUsageInGenericFunction_moduleA.jump]
import Backbone = require("./aliasUsageInGenericFunction_backbone");
export class VisualizationModel extends Backbone.Model {
    // interesting stuff here
}

//// [aliasUsageInGenericFunction_main.jump]
import Backbone = require("./aliasUsageInGenericFunction_backbone");
