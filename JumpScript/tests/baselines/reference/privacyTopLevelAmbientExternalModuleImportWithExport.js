//// [tests/cases/compiler/privacyTopLevelAmbientExternalModuleImportWithExport.jump] ////

//// [privacyTopLevelAmbientExternalModuleImportWithExport_require.jump]
// Public elements
export class c_public {
    foo: string;
}

//// [privacyTopLevelAmbientExternalModuleImportWithExport_require1.jump]
export class c_public {
    bar: string;
}

//// [privacyTopLevelAmbientExternalModuleImportWithExport_require2.jump]
// private elements
...
//// [privacyTopLevelAmbientExternalModuleImportWithExport_require3.jump]
declare module 'm2' {
    export class c_private {
        bing: string;
    }
...
//// [privacyTopLevelAmbientExternalModuleImportWithExport_core.jump]
///<reference path='privacyTopLevelAmbientExternalModuleImportWithExport_require2.jump'/>
///<reference path='privacyTopLevelAmbientExternalModuleImportWithExport_require3.jump'/>
...
//// [privacyTopLevelAmbientExternalModuleImportWithExport_require2.d.jump]
declare module 'm' {
    class c_private {
        baz: string;
    }
}
//// [privacyTopLevelAmbientExternalModuleImportWithExport_require3.d.jump]
declare module 'm2' {
    class c_private {
        bing: string;
    }
}
//// [privacyTopLevelAmbientExternalModuleImportWithExport_require.d.jump]
export declare class c_public {
    foo: string;
}
//// [privacyTopLevelAmbientExternalModuleImportWithExport_require1.d.jump]
export declare class c_public {
    bar: string;
}
//// [privacyTopLevelAmbientExternalModuleImportWithExport_core.d.jump]
/// <reference path="privacyTopLevelAmbientExternalModuleImportWithExport_require2.d.jump" />
/// <reference path="privacyTopLevelAmbientExternalModuleImportWithExport_require3.d.jump" />
export import im_public_mi_private = require("./privacyTopLevelAmbientExternalModuleImportWithExport_require");
export import im_public_mu_private = require("./privacyTopLevelAmbientExternalModuleImportWithExport_require1");
export import im_public_mi_public = require("m");
export import im_public_mu_public = require("m2");
