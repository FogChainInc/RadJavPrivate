//// [tests/cases/compiler/declFileCallSignatures.jump] ////

//// [declFileCallSignatures_0.jump]
...
//// [declFileCallSignatures_0.d.jump]
export interface ICallSignature {
    /** This comment should appear for foo*/
    (): string;
}
...
//// [declFileCallSignatures_1.d.jump]
interface IGlobalCallSignature {
    /** This comment should appear for foo*/
    (): string;
}
