//// [tests/cases/compiler/extendingClassFromAliasAndUsageInIndexer.jump] ////

//// [extendingClassFromAliasAndUsageInIndexer_backbone.jump]
export class Model {
    public someData: string;
}

//// [extendingClassFromAliasAndUsageInIndexer_moduleA.jump]
import Backbone = require("./extendingClassFromAliasAndUsageInIndexer_backbone");
export class VisualizationModel extends Backbone.Model {
    // interesting stuff here
}

//// [extendingClassFromAliasAndUsageInIndexer_moduleB.jump]
import Backbone = require("./extendingClassFromAliasAndUsageInIndexer_backbone");
export class VisualizationModel extends Backbone.Model {
    // different interesting stuff here
}

//// [extendingClassFromAliasAndUsageInIndexer_main.jump]
import Backbone = require("./extendingClassFromAliasAndUsageInIndexer_backbone");
