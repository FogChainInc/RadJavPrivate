//// [tests/cases/compiler/collisionExportsRequireAndModule.jump] ////

//// [collisionExportsRequireAndModule_externalmodule.jump]
...
//// [collisionExportsRequireAndModule_globalFile.jump]
module require {
    export interface I {
    }
    export class C {
