...
(function (JumpScript) {
    ...
    JumpScript.AstWalkOptions = AstWalkOptions;
    ...
    JumpScript.AstWalkerFactory = AstWalkerFactory;
    ...
    JumpScript.getAstWalkerFactory = getAstWalkerFactory;
    var ChildrenWalkers;
