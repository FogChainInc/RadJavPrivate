//// [tests/cases/compiler/declFileExportImportChain2.jump] ////

//// [declFileExportImportChain2_a.jump]
module m1 {
    export module m2 {
        export class c1 {
        }
...
//// [declFileExportImportChain2_b.jump]
import a = require("declFileExportImportChain2_a");
export = a;

//// [declFileExportImportChain2_c.jump]
export import b = require("declFileExportImportChain2_b");

//// [declFileExportImportChain2_d.jump]
...
//// [declFileExportImportChain2_a.d.jump]
declare module m1 {
    module m2 {
        class c1 {
        }
...
export = m1;
//// [declFileExportImportChain2_b.d.jump]
import a = require("declFileExportImportChain2_a");
export = a;
//// [declFileExportImportChain2_c.d.jump]
export import b = require("declFileExportImportChain2_b");
//// [declFileExportImportChain2_d.d.jump]
import c = require("declFileExportImportChain2_c");
