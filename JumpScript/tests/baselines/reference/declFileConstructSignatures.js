//// [tests/cases/compiler/declFileConstructSignatures.jump] ////

//// [declFileConstructSignatures_0.jump]
...
//// [declFileConstructSignatures_1.jump]
...
//// [declFileConstructSignatures_0.d.jump]
export interface IConstructSignature {
    /** This comment should appear for foo*/
    new (): string;
}
...
//// [declFileConstructSignatures_1.d.jump]
interface IGlobalConstructSignature {
    /** This comment should appear for foo*/
    new (): string;
}
