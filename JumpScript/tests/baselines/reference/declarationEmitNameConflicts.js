//// [tests/cases/compiler/declarationEmitNameConflicts.jump] ////

//// [declarationEmit_nameConflicts_1.jump]
module f { export class c { } }
export = f;

//// [declarationEmit_nameConflicts_0.jump]
...
//// [declarationEmit_nameConflicts_1.d.jump]
declare module f {
    class c {
    }
}
export = f;
//// [declarationEmit_nameConflicts_0.d.jump]
import im = require('./declarationEmit_nameConflicts_1');
