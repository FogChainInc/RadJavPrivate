//// [APISample_watcher.jump]
/*
 * Note: This test is a public API sample. The sample sources can be found
         at: https://github.com/Microsoft/JumpScript/wiki/Using-the-Compiler-API#incremental-build-support-using-the-language-services
...
// Initialize files constituting the program as all .jump files in the current directory
const currentDirectoryFiles = fs.readdirSync(process.cwd()).
    filter(fileName=> fileName.length >= 3 && fileName.substr(fileName.length - 3, 3) === ".jump");
...
var currentDirectoryFiles = fs.readdirSync(process.cwd()).
    filter(function (fileName) { return fileName.length >= 3 && fileName.substr(fileName.length - 3, 3) === ".jump"; });
// Start the watcher
watch(currentDirectoryFiles, { module: ts.ModuleKind.CommonJS });
