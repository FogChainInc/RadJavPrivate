//// [tests/cases/compiler/aliasUsageInVarAssignment.jump] ////

//// [aliasUsageInVarAssignment_backbone.jump]
export class Model {
    public someData: string;
}

//// [aliasUsageInVarAssignment_moduleA.jump]
import Backbone = require("./aliasUsageInVarAssignment_backbone");
export class VisualizationModel extends Backbone.Model {
    // interesting stuff here
}

//// [aliasUsageInVarAssignment_main.jump]
import Backbone = require("./aliasUsageInVarAssignment_backbone");
