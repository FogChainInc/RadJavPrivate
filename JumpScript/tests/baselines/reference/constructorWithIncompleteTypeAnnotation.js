//// [constructorWithIncompleteTypeAnnotation.jump]
declare module "fs" {
    export class File {
...
JumpScriptAllInOne.Program.Main();
...
var fs = module;
("fs");
var JumpScriptAllInOne;
(function (JumpScriptAllInOne) {
    ...
    JumpScriptAllInOne.Program = Program;
     != 0;
    {
        return 1;
            ^
    ...
    console.log('Done');
    return 0;
})(JumpScriptAllInOne || (JumpScriptAllInOne = {}));
