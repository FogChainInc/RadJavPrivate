//// [tests/cases/compiler/aliasUsageInTypeArgumentOfExtendsClause.jump] ////

//// [aliasUsageInTypeArgumentOfExtendsClause_backbone.jump]
export class Model {
    public someData: string;
}

//// [aliasUsageInTypeArgumentOfExtendsClause_moduleA.jump]
import Backbone = require("./aliasUsageInTypeArgumentOfExtendsClause_backbone");
export class VisualizationModel extends Backbone.Model {
    // interesting stuff here
}

//// [aliasUsageInTypeArgumentOfExtendsClause_main.jump]
import Backbone = require("./aliasUsageInTypeArgumentOfExtendsClause_backbone");
